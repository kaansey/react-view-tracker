...
var ViewTracker = function (props) {
    var observer = null;
    ...
    var init = function () {
        var threshold = props.visiblePercentage, offset = props.offset;
        var root = null;
        if (props.setRootContainer) {
            root = props.setRootContainer();
        }
        var rootMargin = offset.top + "px " + offset.right + "px " + offset.bottom + "px " + offset.left + "px";
    ...
    return React.createElement("div", { ref: containerRef }, props.children);
};
ViewTracker.defaultProps = {
    onShow: function () { return void 0; },
    onHide: function () { return void 0; },
    onStartObserving: function () { return void 0; },
    onStopObserving: function () { return void 0; },
    once: false,
    offset: {
        left: 0,
        right: 0,
